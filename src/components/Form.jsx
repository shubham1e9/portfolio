...
const Form = () => {
    ...
    const formSubmitHandler = (e) => {
        ...
        send(
            "service_rifan5c", // Service ID
            "template_16jyu4f", // Template ID
            userInput,
            "lB4-gIgcNcU5ncawz" // Public Key - https://dashboard.emailjs.com/admin/account
        )
            .then((response) => {
        ...
        <Div className="max-w-[1200px] mx-auto">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            name="from_name"
                            type="text"
                            className="h-[64px] bg-white outline-none rounded-lg border-none text-black px-4"
                            required
                            autoComplete="off"
                            onChange={onChange}
                        />
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <textarea
                        name="message"
                        className="h-[162px] bg-white outline-none rounded-lg border-none text-black p-4 resize-none"
                        required
                        onChange={onChange}
                    />
                </div>
                ...
                {/* SUBMIT BUTTON */}
                <button className="bg-[#111111] h-[64px] max-w-[200px] text-[22px] rounded-md transition-transform active:scale-[0.95] ">
                    Send
                </button>
                {/* SUBMIT BUTTON */}
            </form>
